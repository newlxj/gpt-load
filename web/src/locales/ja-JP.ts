export default {
  ...
  subGroups: {
    ...
    rateLimitConfigTooltip: "グループのリクエスト頻度制限と有効期限を設定",
    expiresAt: "有効期限",
    selectExpireTime: "有効期限を選択",
    maxRequestsPerHour: "1時間あたりの最大リクエスト数",
    maxRequestsPerHourTooltip: "1時間あたりの最大リクエスト数を制限、0は無制限",
    maxRequestsPerMonth: "1ヶ月あたりの最大リクエスト数",
    maxRequestsPerMonthTooltip: "1ヶ月あたりの最大リクエスト数を制限、0は無制限",
    noLimit: "0は無制限",
    expiredGroup: "グループの有効期限が切れています",
    rateLimitExceeded: "リクエスト頻度制限を超過しました",
    willExpireAt: "{time}に期限切れ",
    currentUsage: "現在の使用量：{used}/{limit}",
    hourlyUsage: "この時間で{count}回使用",
    monthlyUsage: "今月{count}回使用",
  },
  logs: {
    title: "ログ",
    requestLogs: "リクエストログ",
    ...
    clientIp: "クライアントIP",
    clearLogs: "ログをクリア",
    clearLogsConfirm: "ログクリアの確認",
    clearLogsWarning: "この操作は、フィルタ条件に基づいてログレコードを永久に削除し、元に戻すことができません。続行してもよろしいですか？",
    clearLogsSuccess: "ログのクリアに成功しました",
