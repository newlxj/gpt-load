export default {
  ...
  subGroups: {
    ...
    // Rate limit and expiry
    rateLimitConfig: "Rate Limit Configuration",
    rateLimitConfigTooltip: "Set request frequency limits and expiration time for this group",
    expiresAt: "Expiration Time",
    selectExpireTime: "Select expiration time",
    maxRequestsPerHour: "Max Requests Per Hour",
    maxRequestsPerHourTooltip: "Limit maximum requests per hour, 0 means no limit",
    maxRequestsPerMonth: "Max Requests Per Month",
    maxRequestsPerMonthTooltip: "Limit maximum requests per month, 0 means no limit",
    noLimit: "0 means no limit",
    expiredGroup: "Group has expired",
    rateLimitExceeded: "Request rate limit exceeded",
    willExpireAt: "Will expire at {time}",
    currentUsage: "Current usage: {used}/{limit}",
    hourlyUsage: "Used {count} times this hour",
    monthlyUsage: "Used {count} times this month",
  },
  logs: {
    title: "Logs",
    ...
    clearLogsConfirm: "Confirm Clear Logs",
    clearLogsWarning: "This operation will permanently delete log records based on the filter criteria and cannot be undone. Are you sure you want to continue?",
  ...
  groupMonitor: {
    ...
    clickToEdit: "Click to edit group",
    loadingFailed: "Loading failed",
    normal: "Normal",
    statusNormal: "Normal",
    statusExpired: "Expired",
    statusQuotaExceeded: "Quota Exceeded",
    "24hours": "24h requests",
    "7days": "7d requests",
    "30days": "30d requests",
  },
  success: {
