export default {
  ...
  subGroups: {
    ...
    rateLimitConfigTooltip: "设置分组的请求频率限制和有效期",
    expiresAt: "有效期",
    selectExpireTime: "选择过期时间",
    maxRequestsPerHour: "每小时最大请求次数",
    maxRequestsPerHourTooltip: "限制每小时的最大请求次数，0表示不限制",
    maxRequestsPerMonth: "每月最大请求次数",
    maxRequestsPerMonthTooltip: "限制每月的最大请求次数，0表示不限制",
    noLimit: "0 表示不限制",
    expiredGroup: "分组已过期",
    rateLimitExceeded: "超过请求频率限制",
    willExpireAt: "将于 {time} 过期",
    currentUsage: "当前使用量：{used}/{limit}",
    hourlyUsage: "本小时已使用 {count} 次",
    monthlyUsage: "本月已使用 {count} 次",
  },
  logs: {
    title: "日志",
    requestLogs: "请求日志",
    ...
    logMessage: "日志消息",
    clearLogs: "清除日志",
    clearLogsConfirm: "确认清空日志",
    clearLogsWarning: "此操作将根据筛选条件永久删除日志记录，无法恢复。确定要继续吗？",
    clearLogsSuccess: "日志清空成功",
    clearLogsFailed: "日志清空失败",
    filterLogs: "筛选日志",
    searchLogs: "搜索日志",
    noLogs: "暂无日志",
    showDetails: "显示详情",
